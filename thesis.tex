...
erzeugen. Energieanbieter müssen in anderen Worten entsprechend dem
...
the help of SAPs In-Memory Computing Engine. It is further shown how
the memory footprint of this data can be minimized through lightweight
...
\begin{figure}
\centering{}\includegraphics[width=0.9\columnwidth]{figures/ami}\caption{\label{fig:AMI}The Advanced Metering Infrastrucutre as depicted in
...
only be used for stress testing, but also for real-time analyses and
...
can be scaled easily, which is the reason why this paper focuses on
the performance of the database system itself.
...
and droped after each test run. Autocommit is disabled as well as
...
of the depicted scenario, the focus of this paper is on lightweight
...
can be evaluated. The meter id column may server as an example. According
